        ...
        <div style={{ maxWidth: 1440, margin: '0 auto', padding: isMobile ? '0 16px' : '0 36px' }}>
          ...
          {isMobile ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
              ...
              <Img src={p('design-uaipizza-hero.png')} alt="Uai Pizza" maxHeight="380px" wrapStyle={{ height: '380px' }} imgStyle={{ height: '100%' }} />
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 32 }}>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <Img src={p('design-uaipizza-hero.png')} alt="Uai Pizza" maxHeight="480px" wrapStyle={{ height: '480px' }} imgStyle={{ height: '100%', boxShadow: '0 10px 36px rgba(0,0,0,0.22)' }} />
              </div>
            </div>
          )}
        </div>
      ...
      <motion.section variants={fadeUp} initial="hidden" whileInView="visible" viewport={VP} transition={FV}
        ...
        <div style={{ maxWidth: 1440, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? 24 : 32, marginBottom: isMobile ? 24 : 32 }}>
            <div>
              <Img src={p('design-uaipizza-positioning.png')} alt="Positioning map" maxHeight="480px" wrapStyle={{ height: '480px' }} imgStyle={{ height: '100%' }} />
              <Caption text="Positioning map" />
            </div>
            <div>
              <Img src={p('design-uaipizza-palette.png')} alt="Color palette" maxHeight="480px" wrapStyle={{ height: '480px' }} imgStyle={{ height: '100%' }} />
              <Caption text="Color palette" />
            </div>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? 24 : 32 }}>
            ...
            <div>
              <Img src={p('design-uaipizza-mockups.png')} alt="Mockups" maxHeight="480px" wrapStyle={{ height: '480px' }} imgStyle={{ height: '100%' }} />
              <Caption text="Mockups" />
            </div>
          </div>
        </div>
      </motion.section>
